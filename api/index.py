...
<style>body{font-family:system-ui;background:#050508;color:#d4d4d8;padding:40px}h1{color:#ff6b35}table{width:100%;border-collapse:collapse;margin-top:20px}th,td{padding:12px;text-align:left;border-bottom:1px solid #1e1e30}th{color:#ff6b35}.num{color:#22c55e;font-weight:700}</style></head><body>
